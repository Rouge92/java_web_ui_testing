...
public class CrmTest {
    ...
    public void createContactTest() {
        ...
        WebElement subMenu = driver.findElement(By.xpath("/html/body/div[2]/div/header/div[2]/ul/li[1]/ul/li[4]/a/span"));
        Actions actions = new Actions(driver);
        actions
                .moveToElement(menuBtn)
                .moveToElement(subMenu)
        ...
        position.click();
        position.sendKeys("Научный сотрудник");
        WebElement save = driver.findElement(By.xpath("/html/body/div[2]/div/div[2]/div[3]/form/div[1]/div/div/div[2]/div[1]/div[4]/button"));
        save.click();
        driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
